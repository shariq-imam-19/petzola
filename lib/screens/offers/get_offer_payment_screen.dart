...
class GetOfferPaymentScreen extends StatefulWidget {

  @override
  _GetOfferPaymentScreenState createState() => _GetOfferPaymentScreenState();
}

class _GetOfferPaymentScreenState extends State<GetOfferPaymentScreen> {
