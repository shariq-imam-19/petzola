...
import 'package:petzola/screens/services/service_booking_personal_info_screen_loggedout2.dart';
class PetServiceBookPersonalInfoScreenLoggedOut extends StatefulWidget {


  @override
  _PetServiceBookPersonalInfoScreenLoggedOutState createState() => _PetServiceBookPersonalInfoScreenLoggedOutState();
}

class _PetServiceBookPersonalInfoScreenLoggedOutState extends State<PetServiceBookPersonalInfoScreenLoggedOut> {
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  CustomButton(
                                      ...
                                      buttonOnTap:(){
                                        Navigator.push(context, MaterialPageRoute(builder: (_)=>PetServiceBookPersonalInfoScreenLoggedOut2()));
                                      }
                                  ),
                                )
                              ]
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  CustomButton(
                                      ...
                                      buttonColor:themeColor1,
                                      buttonTextColor:themeColor2,
                                      buttonText: isLoggedIn ? "Next : Service Details (AED426)" : "Next",
                                      buttonFontFamily:'sfdm',
                                      buttonOnTap:(){
                                        Navigator.push(context, MaterialPageRoute(builder: (_)=>PetServiceBookPersonalInfoScreenLoggedOut2()));
                                      }
  ...
  Widget renderAddPetDetails(var height, var width){
    return Column(
      children: [
        VariableText(text:getTranslated(context, 'Time To Add Your Best'), textAlign: TextAlign.center, fontcolor: Colors.black, max_lines: 2, fontFamily: "sftr",fontsize: height*0.026,),
        VariableText(text: getTranslated(context, 'Friend (Your Pet)!'), textAlign: TextAlign.center, fontcolor: Colors.black, max_lines: 2, fontFamily: "sftr",fontsize: height*0.026,),
        SizedBox(height: height*0.03,),
        Center(
          child: Container(
            child: CircleAvatar(
          ...
          children: [
            Expanded(
              child: RectangluartextFeild(
                ...
                heights: 65,
                maxLines: 1,
                hinttext: getTranslated(context, "Pet's Name"),
              ),
            ),
          ],
        ),
        SizedBox(height: height*0.01,),
        //yahan par select breed ka dropdown laga dena yaad se
        Row(
          children: [
            Expanded(
              child: RectangluartextFeildWithIcon(
                ...
                fontsize: height*0.019,
                enable: false,
                hinttext: showBreedType==null ? getTranslated(context, "Search Breed") : showBreedType,
    ...
    showModalBottomSheet(
      ...
      return DraggableScrollableSheet(
          ...
          builder: (context, scrollController) {
            return SearchBreed(height:height,width:width,landscapOrientation: false,
              onselected: (temp){
