                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                RectangluartextFeild(
                                  heights: height*0.07,
                                  //widths: height*0.95,
                                  hinttext: getTranslated(context, "Your Name"),
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      child: VariableText(text:getTranslated(context, "Change Password"),
                                        underlined: true,
    ...
    showModalBottomSheet(
      ...
      return DraggableScrollableSheet(
          ...
          builder: (context, scrollController) {
            return ChangePasswordBottomSheet(height: height,width: width,viewPassword1: viewPassword1,viewPassword2: viewPassword2,viewPassword3: viewPassword3,);
...
class ChangePasswordBottomSheet extends StatefulWidget {
  double height,width;
  bool viewPassword1,viewPassword2,viewPassword3;
  ChangePasswordBottomSheet({this.height,this.width,this.viewPassword1,this.viewPassword2,this.viewPassword3,});
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            VariableText(text: getTranslated(context, "Change Password") ,
                ...
                children: [
                  Expanded(
                    child: RectangluartextFeildWithIcon(
                      ...
                      texthidden:widget. viewPassword1?true:false,
                      onTap: (){

                        setState(() {

                          if(widget.viewPassword1==false){
                            widget.viewPassword1=true;
                          }
                          else{
                            widget.viewPassword1=false;
                          }
                        });
                      },
                ...
                children: [
                  Expanded(
                    child: RectangluartextFeildWithIcon(
                      ...
                      texthidden: widget.viewPassword2?true:false,
                      onTap: (){

                        setState(() {

                          if(widget.viewPassword2==false){
                            widget.viewPassword2=true;
                          }
                          else{
                            widget.viewPassword2=false;
                          }
                        });
                      },
                      fontsize: widget.height*0.019,
                ...
                children: [
                  Expanded(
                    child: RectangluartextFeildWithIcon(
                      ...
                      texthidden: widget.viewPassword3?true:false,
                      onTap: (){

                        setState(() {

                          if(widget.viewPassword3==false){
                            widget. viewPassword3=true;
                          }
                          else{
                            widget.viewPassword3=false;
                          }
                        });
                      },
                      fontsize: widget.height*0.019,

                      hinttext: getTranslated(context, "Repeat New Password"),
                      imageIconPath: "lib/assets/icons/eyeicon.png",
                      keytype: TextInputType.text,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: CustomButton(
                        buttonHeight: widget.height*0.07,
                        buttonBorderRadius:8,
                        buttonFontSize:widget.height*0.025,
                        buttonColor:themeColor1,
                        buttonTextColor:themeColor2,
                        buttonText: getTranslated(context, "Save New Password"),
                        buttonFontFamily:'sfdm',
                        buttonOnTap:(){
