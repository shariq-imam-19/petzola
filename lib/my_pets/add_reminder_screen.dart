...
class MyPetAddReminderScreen extends StatefulWidget {
  var petDetails;
  Function onSave;

  MyPetAddReminderScreen({this.petDetails, this.onSave});


  @override
  _MyPetAddReminderScreenState createState() => _MyPetAddReminderScreenState();
}

class _MyPetAddReminderScreenState extends State<MyPetAddReminderScreen> with  TickerProviderStateMixin{
